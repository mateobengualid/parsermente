 ...
 * @author mateo
 */
public class LTSDOCTYPState extends SAXParserState
{
    public LTSDOCTYPState(SAXHandler userHandler)
    {
        super(userHandler);
    }
    ...
    {
        // Is a <!DOCTYPE for <!DOCTYPE[]>
        if (c == 'E')
        {
            return new LTSDOCTYPEState(handler);
        }
        else
        {
